...
import styles from './EmploymentServicesPage.module.css';

export default function EmploymentServicesPage() {
  const t = useTranslations('employmentServices');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      setFormData({ name: '', company: '', contact: '', employees: '', message: '' });
  ...
  return (
    <div className={styles.page}>
      ...
      {/* Block 2: Our End-to-End Employment Services */}
                  ...
                  <div className={styles.serviceIcon}>
                    ...
                    {num === 3 && (
                      <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M12 11C14.2 11 16 9.2 16 7C16 4.8 14.2 3 12 3C9.8 3 8 4.8 8 7C8 9.2 9.8 11 12 11Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                        <path d="M8 14C6.3 14 5 15.3 5 17V21H19V17C19 15.3 17.7 14 16 14" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                    )}
                    {num === 4 && (
                      <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Block 3: Why Professional Onboarding Matters */}
        ...
        <div className={styles.benefitsContainer}>
          <div className={`${styles.benefitsContent} ${isBenefitsVisible ? styles.visible : ''}`}>
            ...
            <div className={styles.benefitsList}>
              {['penalties', 'time', 'experience', 'requirements'].map((item) => (
                <div key={item} className={styles.benefitItem}>
                  ...
                  <div className={styles.benefitContent}>
                    <h3 className={styles.benefitTitle}>{t(`benefits.${item}.title`)}</h3>
                    <p className={styles.benefitDescription}>{t(`benefits.${item}.description`)}</p>
                  </div>
                </div>
              ))}
            </div>
      ...
      {/* Block 4: Our Simple 4-Step Onboarding Process */}
      ...
      {/* Block 5: Ready to Grow Your Team? */}
                ...
                <form className={styles.contactForm} onSubmit={handleSubmit}>
                  ...
                  <div className={styles.formGroup}>
                    <input
                      ...
                      onChange={handleInputChange}
                      placeholder={t('contact.form.employees')}
                      required
                      className={styles.formInput}
                    />
                  </div>
